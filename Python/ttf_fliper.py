"""
    Example input: num = 40,  (0010 1000)

    First swap the nibbles
    0010 1000 -> 1000 0010

    Then reverse the bit order of the nibbles
    1000 0010 -> 0001 0100 = 20

"""
def reverse_nibbles(num):
    mask1 = num & 15
    mask2 = (num & 240) >> 4
    new1 = int(0)
    new2 = int(0)
...
reverse_table = [0, 128, 64, 192, 32, 160, 96, 224, 16, 144, 80, 208, 48, 176, 112, 240, 8, 136, 72, 200, 40, 168,
...
if __name__ == '__main__':
    ...
    with open(r"..\NES\output_files\NES.ttf", "r") as txt_file:
        ...
        for line in lines:
            ...
            for i in range(len(nums)):
                nums[i] = reverse_table[nums[i]]

            output.append(','.join(map(str, nums)))

        output = ',\n'.join(output)

    with open(r"..\Arduino\Sketch\fpga_program.h", "w") as text_file:
