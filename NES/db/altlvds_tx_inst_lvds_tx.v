...
//CBXI_INSTANCE_NAME="CPU_TESTING_hdmi_inst14_serializer_serializer_altlvds_tx_ALTLVDS_TX_component"
...
//altddio_out CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone 10 LP" WIDTH=4 aclr datain_h datain_l dataout outclock
...
`endif
	...
	cyclone10lp_ddio_out   ddio_outa_1
	( 
	.areset(aclr),
	.clkhi(outclock),
	.clklo(outclock),
	...
	defparam
		...
		ddio_outa_1.lpm_type = "cyclone10lp_ddio_out";
	cyclone10lp_ddio_out   ddio_outa_2
	( 
	.areset(aclr),
	.clkhi(outclock),
	.clklo(outclock),
	...
	defparam
		...
		ddio_outa_2.lpm_type = "cyclone10lp_ddio_out";
	cyclone10lp_ddio_out   ddio_outa_3
	( 
	.areset(aclr),
	.clkhi(outclock),
	.clklo(outclock),
	...
	defparam
		...
		ddio_outa_3.lpm_type = "cyclone10lp_ddio_out";
	assign
...
//lpm_counter CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone 10 LP" lpm_modulus=5 lpm_width=3 aclr clock q updown
